...
3. 修改 **bin** 目录下的 ***idea.exe.vmoptions*** 和 ***idea64.exe.vmoptions*** 配置文
  ...
  > -javaagent:D:\Application\IntelliJ IDEA 2018.3.6\bin\JetbrainsIdesCrack-4.2-release-sha1-3323d5d0b82e716609808090d3dc7cb3198b8c4b.jar

  **注意：添加的这一行代码，路径是下载的jar包路径，要改成自己的路径**

  ![q9MsKT](https://media.zenghr.cn/blog/img/20210322/q9MsKT.png)
