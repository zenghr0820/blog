...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,7);function v(g,m){const e=l("ExternalLinkIcon");return t(),p("div",null,[r,n("ol",null,[n("li",null,[s("下载源码包，或者去"),n("a",d,[s("Nginx官网"),c(e)]),s("下载源码包")])]),u])}const k=i(o,[["render",v],["__file","01.安装Nginx.html.vue"]]);export{k as default};
