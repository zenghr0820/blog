...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>手动启动dockerd的时候，添加<code>--registry-mirror</code>参数: <code>dockerd --registry-mirror=https://&lt;my-docker-mirror-host&gt;</code></li></ol>`,4);function _(g,x){const e=t("ExternalLinkIcon");return c(),l("div",null,[d,n("p",null,[s("选择你需要的 docker 版本，下载地址："),n("a",u,[s("https://download.docker.com/linux/static/stable/x86_64"),a(e)])]),p,n("ul",null,[n("li",null,[n("a",v,[s("https://dockerhub.azk8s.cn"),a(e)]),s(" - Azure镜像")]),n("li",null,[n("a",m,[s("http://hub-mirror.c.163.com"),a(e)]),s(" - 网易镜像")]),n("li",null,[n("a",b,[s("https://docker.mirrors.ustc.edu.cn"),a(e)]),s(" - 科大镜像站")]),n("li",null,[n("a",k,[s("https://registry.docker-cn.com"),a(e)]),s(" - Docker中国官方镜像")]),h]),f])}const q=r(o,[["render",_],["__file","01.安装Docker.html.vue"]]);export{q as default};
