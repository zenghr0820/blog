import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as e,a as s}from"./app-5b7fea30.js";const i={},l=s(`<h2 id="启动、重启、停止命令" tabindex="-1"><a class="header-anchor" href="#启动、重启、停止命令" aria-hidden="true">#</a> 启动、重启、停止命令</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 启动</span>
