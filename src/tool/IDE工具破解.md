...
- JAR 包链接: [JAR包 百度云链接](https://pan.baidu.com/s/1xClg5k2iABFekvXf7WlJKg)
...
2. 将下载后的 JAR 包放入到 IDEA 安装目录的 **bin** 目录下，如下图

     ![6uwE6R](https://media.zenghr.cn/blog/img/20210325/6uwE6R.png)
...
3. 修改 **bin** 目录下的 ***`idea.exe.vmoptions`*** 和 ***`idea64.exe.vmoptions`*** 配置文
  ...
  **注意：添加的这一行代码，路径要改成自己的路径**

  ![wyYtY8](https://media.zenghr.cn/blog/img/20210322/wyYtY8.png)

4. 修改完成打开 IDEA，没激活会弹出激活窗口界面，如下图：

   <img alt="激活窗口" src="https://media.zenghr.cn/blog/img/20210325/lEPTGb.png" width="60%">
...
6. 可以看到激活至2100，代表激活成功，如图：

   <img alt="激活成功" src="https://media.zenghr.cn/blog/img/20210325/OyPGYM.png" width="70%">
